  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        if (searchParams.get("max_price")) filters.max_price = Number(searchParams.get("max_price"));
    ...
    load();
  }, [priceRange, condition, searchParams]);
        ...
        <div className="flex gap-8">
          <aside className="w-64 flex-shrink-0">
            <div className="bg-zinc-800 rounded-lg p-6 border border-zinc-700 sticky top-8">
              ...
              <div className="mb-6">
                ...
                <Slider min={0} max={55000} step={500} value={priceRange} onValueChange={setPriceRange}
              ...
              <div className="mb-6">
                ...
                <Select onValueChange={(v) => setCondition(v === "all" ? "" : v)}>
                  <SelectTrigger className="bg-zinc-900 border-zinc-700 text-white"><SelectValue placeholder="Any condition" /></SelectTrigger>
              ...
              <Button onClick={() => { setPriceRange([0, 55000]); setCondition(""); }}
                className="w-full bg-zinc-700 hover:bg-zinc-600 text-white">Clear filters</Button>
            </div>
          </aside>
          ...
          <main className="flex-1">
            <div className="mb-6">
              ...
              <p className="text-gray-400">{loading ? "Loading..." : `${listings.length} cars found`}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {listings.map((car) => (
                <div key={car._id} className="bg-zinc-800 rounded-lg overflow-hidden border border-zinc-700 hover:border-green-400 transition-all duration-300 group">
