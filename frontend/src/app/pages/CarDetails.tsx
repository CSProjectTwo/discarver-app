...
import { Heart, MapPin, ArrowLeft, Phone, Mail, User } from "lucide-react";
  ...
  if (error || !listing) return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center">
      <div className="text-center">
        ...
        <Link to="/search">
          <Button className="bg-green-400 hover:bg-green-500 text-zinc-900">Back to Search</Button>
        </Link>
      </div>
    </div>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <div className="bg-zinc-800 rounded-lg overflow-hidden mb-4 border border-zinc-700">
              <img src={images[displayImage]} alt={listing.title}
            ...
            <div className="bg-zinc-800 rounded-lg p-6 border border-zinc-700 sticky top-8">
              ...
              <div className="mb-6 pb-6 border-b border-zinc-700">
                <div className="flex items-center gap-2 text-gray-300">
                  ...
                  <span>{listing.seller_details?.location}</span>
                </div>
              </div>
              ...
              <div className="mb-6 pb-6 border-b border-zinc-700">
                ...
                <div className="flex items-center gap-2 text-gray-300">
                  ...
                  <span>{listing.seller_details?.name}</span>
                </div>
        ...
        <DialogContent className="bg-zinc-800 border-zinc-700 text-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400">
              Get in touch with the seller to arrange a viewing.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="bg-zinc-900 rounded-lg p-4 border border-zinc-700">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-white">{listing.seller_details?.name}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-white">{listing.seller_details?.location}</p>
                </div>
              </div>
            </div>
            <div className="bg-zinc-900 rounded-lg p-4 border border-zinc-700">
          ...
          <Button onClick={() => setShowContactModal(false)}
            className="w-full bg-green-400 hover:bg-green-500 text-zinc-900 font-semibold mt-4">
            Close
          </Button>
        </DialogContent>
      </Dialog>
